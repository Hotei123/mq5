...
private:
   ...
   //--- New member for the horizontal diameter
   CChartObjectLabel *m_horizontal_diameter[2]; 
...
//---
   ...
   //--- Create the horizontal diameter labels
   m_horizontal_diameter[0] = new CChartObjectLabel;
   if(m_horizontal_diameter[0] == NULL || !m_horizontal_diameter[0].Create(0, "hd_left_"+string(id), 0, 0, 0)) return false;
   m_horizontal_diameter[0].Color(clrWhite);
   m_horizontal_diameter[0].Description("—");

   m_horizontal_diameter[1] = new CChartObjectLabel;
   if(m_horizontal_diameter[1] == NULL || !m_horizontal_diameter[1].Create(0, "hd_right_"+string(id), 0, 0, 0)) return false;
   m_horizontal_diameter[1].Color(clrWhite);
   m_horizontal_diameter[1].Description("—");
...
//---
   ...
   //--- Recalculate the position of the horizontal diameter
   if(m_horizontal_diameter[0]!=NULL && m_horizontal_diameter[1]!=NULL)
     {
      m_horizontal_diameter[0].X_Distance(m_center_X - m_radius);
      m_horizontal_diameter[0].Y_Distance(m_center_Y);
      m_horizontal_diameter[1].X_Distance(m_center_X + m_radius);
      m_horizontal_diameter[1].Y_Distance(m_center_Y);
     }
  }
//+------------------------------------------------------------------+
//| auxiliary function                                               |
